                        ...
                        <div className="container">
                            <div className="d-flex justify-content-end">
                                <ul className="list-unstyled e-p-bx">
                                    <li><span>Mail us:</span> intaainteriors@gmail.com</li>
                                    <li><span>Call us:</span>+91 76740 60206</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div className="col-xl-6 col-lg-6 col-md-12">
                                                    <div className=" contact-nav-info">
                                                        ...
                                                        <div className="full-social-bg">
                                                            <ul>
                                                                <li><a href="https://www.facebook.com" target="_blank" rel="noreferrer"><i className="fa fa-facebook" /></a></li>
                                                                <li><a href="https://www.instagram.com" target="_blank" rel="noreferrer"><i className="fa fa-instagram" /></a></li>
                                                                <li><a href="https://www.youtube.com" target="_blank" className="youtube" rel="noreferrer"><i className="fa fa-youtube" /></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
