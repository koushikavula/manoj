                                    ...
                                    <div className="project-detail-containt">
                                        <div className="bg-white text-black">
                                            ...
                                            <li><a href="https://www.facebook.com" target="_blank" rel="noreferrer" className="fa fa-facebook" /></li>
                                                <li><a href="https://twitter.com" target="_blank" rel="noreferrer"className="fa fa-twitter" /></li>
                                                <li><a href="https://in.linkedin.com" target="_blank"rel="noreferrer" className="fa fa-linkedin" /></li>
                                                <li><a href="https://rss.com" target="_blank" rel="noreferrer"className="fa fa-rss" /></li>
                                                <li><a href="https://www.youtube.com" target="_blank" rel="noreferrer"className="fa fa-youtube" /></li>
